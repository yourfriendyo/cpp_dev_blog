...
core dump可以帮助我们更加方便地调试，可以直接显示错误出现的行数。

<img src="05-进程控制.assets/core dump事后调试图示示例.png"  style="zoom: 50%;" />

> centos默认关闭Core Dump 功能，设置方式如图所示：

<img src="05-进程控制.assets/打开Core Dump功能图示.png" style="zoom:50%;" />

`waitpid`可以获取子进程的退出信息，退出码、退出信号以及core dump标志位。如果进程异常退出，且core dump标志位被设置的话，可能会形成core dump文件。
...
<img src="05-进程控制.assets/进程程序替换失败的返回值图示示例.png" style="zoom:40%;" />
