...
<img src="06-基础IO.assets/image-20230418013838141.png" style="zoom: 33%;" />
...
> 软连接一般用于将一个其他目录下的文件提到当前目录下，一般用来链接库文件。
...
第三组数据就是当前文件的硬链接数。本质是一种引用计数，表示分区内该 inode 存在多少对映射关系。等到硬链接数为0时，再将该文件从系统中删除。
...
<img src="06-基础IO.assets/Makefile编译的依据是文件内容修改时间图示示例.png" style="zoom: 38%;" />
...
<img src="06-基础IO.assets/ldd查看可执行程序依赖的动态库图示示例.png" style="zoom: 38%;" />
...
<img src="06-基础IO.assets/使用动态库图示示例.png" style="zoom: 33%;" />
